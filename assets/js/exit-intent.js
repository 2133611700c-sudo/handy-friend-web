(function () {
  ...
  function createPopup() {
    ...
    overlay.innerHTML = '' +
      '<div style="background:#fff;max-width:420px;width:100%;border-radius:12px;padding:20px;box-sizing:border-box;position:relative">' +
        ...
        '<h3 style="margin:0 0 8px;font-size:22px;color:#111">Wait \u2014 Get Your Free Estimate!</h3>' +
  ...
  /* DESKTOP: trigger when mouse leaves top of page */
  function onDesktopMouseMove(e) {
    if (isMobile) return;
    if (e.clientY < 10) createPopup();
  }

  /* MOBILE: trigger on scroll-up > 30% of page */
