...
async function callAlex(messages, systemPrompt) {
  ...
  audit.latency_ms = Date.now() - t0;
  return {
    reply: "Thanks for reaching out. Please send a photo, ZIP code, and what needs to be done. Sergii will review and reply shortly. You can also call/text (213) 361-1700.",
