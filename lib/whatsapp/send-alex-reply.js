...
async function sendAlexReply({ inboundWamid, customerPhone, customerName, customerMessage, replyText, source = 'model', model = null, audit = null }) {
  ...
  // Persist outbound row linked to inbound + structured DeepSeek audit.
