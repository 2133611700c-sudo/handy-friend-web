...
const SERVICES = {
  ...
  kitchen_cabinet_painting: {
    ...
    category: SERVICE_CATEGORY.QUOTE_ONLY,
    unit: 'quote_only',
    public_anchor: { price_per_door: 70, paint_included: true, note: 'Anchor price — final quote after photos and count' },
    channel_visibility: ['website', 'ai_chat', 'messenger', 'jsonld'],
...
const CABINET_PAINTING_ANCHOR = Object.freeze({
  service_id: 'kitchen_cabinet_painting',
  price_per_door: 70,
  paint_included: true,
  note: 'Public anchor only. Final quote requires door/drawer count, photos, and condition review.',
  currency: 'USD',
});
...
function getAlexPricingCatalogLines() {
  return [
    ...
    '- Kitchen cabinet painting: $70/door anchor (paint included); final quote requires door/drawer count, photos open and closed, and condition review',
    '- Furniture painting',
    '',
