...
const CROSS_SELL_TEXT = {
  en: {
    tv_mounting: 'By the way, we can also hang mirrors/art in the same visit for $95. Want me to add it? Book both and save 20%.',
    art_mirrors: 'By the way, we can also mount your TV in the same visit from $105. Want me to add it? Book both and save 20%.',
    furniture_assembly: 'By the way, we can also mount your TV in the same visit from $105. Want me to add it? Book both and save 20%.',
    kitchen_cabinet_painting: 'By the way, we can also add furniture painting from $40. Want me to add it? Book both and save 20%.',
    furniture_painting: 'By the way, we can also add cabinet painting from $75/door. Want me to add it? Book both and save 20%.',
    interior_painting: 'By the way, we can also add flooring from $3/sq ft. Want me to add it? Book both and save 20%.',
    flooring: 'By the way, we can also add interior painting from $3/sq ft. Want me to add it? Book both and save 20%.',
    generic: 'By the way, you can bundle one more service in the same visit and save 20%.'
  },
  ru: {
