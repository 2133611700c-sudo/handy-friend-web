...
const SERVICE_KEYWORDS = [
  ...
  { id: 'flooring', keywords: ['flooring', 'laminate', 'lvp', 'vinyl floor', 'vinyl plank', 'укладка пола', 'установка пола', 'установка полов', 'установки пола', 'постелить пол', 'положить пол', 'ламинат', 'підлога', 'покласти підлогу', 'ламінат', 'piso', 'pisos', 'instalar piso', 'colocar piso'] },
  ...
  { id: 'drywall', keywords: ['drywall', 'drywall repair', 'patch drywall', 'hole in wall', 'wall hole', 'гипсокартон', 'дырка в стене', 'заплатка', 'гіпсокартон', 'yeso', 'pared rota'] },
  { id: 'door_installation', keywords: ['door install', 'door replacement', 'interior door', 'prehung door', 'установка двер', 'заменить дверь', 'двер', 'puerta', 'instalar puerta'] },
  { id: 'vanity_installation', keywords: ['vanity install', 'vanity replacement', 'bathroom vanity', 'установка тумб', 'тумба', 'умывальник', 'mueble baño', 'vanidad'] },
  { id: 'backsplash', keywords: ['backsplash', 'tile backsplash', 'peel and stick', 'kitchen backsplash', 'фартук кухн', 'плитка фартук', 'backsplash cocina', 'azulejo cocina'] }
];
...
const CROSS_SELL_TEXT = {
  en: {
    tv_mounting: 'By the way, we can also hang mirrors/art in the same visit — $150 service call covers both. Want me to add it?',
    art_mirrors: 'By the way, we can also mount your TV in the same visit — $150 service call. Want me to add it?',
    furniture_assembly: 'By the way, we can also mount your TV in the same visit — $150 service call. Want me to add it?',
    kitchen_cabinet_painting: 'By the way, we can also add furniture painting in the same visit — written quote required. Want me to add it?',
    furniture_painting: 'By the way, we can also add cabinet painting in the same visit — quote after photos. Want me to add it?',
    interior_painting: 'By the way, we can also add flooring in the same project — $3/sf labor estimate, materials separate. Want me to add it?',
    flooring: 'By the way, we can also add interior painting in the same project — $3/sf labor estimate, materials separate. Want me to add it?',
    generic: 'By the way, we can bundle one more related service in the same visit. Want me to add it?'
  },
  ru: {
    generic: 'Кстати, можно добавить еще одну услугу в этот же визит — одна бригада, один выезд.'
  },
  uk: {
    generic: 'До речі, можна додати ще одну послугу в цей же візит — одна бригада, один виїзд.'
  },
  es: {
    generic: 'Por cierto, puedes agregar otro servicio en la misma visita — mismo equipo, un solo viaje.'
  }
};
