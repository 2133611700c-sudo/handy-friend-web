...
async function generateWhatsAppAlexReply(params) {
  ...
  return {
    ...
    audit: r.audit || null, // structured DeepSeek call proof for forensic audit
    detectedLanguage: r.detectedLanguage || null,
    replyLanguage: r.replyLanguage || null,
    languageConfidence: r.languageConfidence ?? null,
    serviceIntent: r.serviceIntent || null,
