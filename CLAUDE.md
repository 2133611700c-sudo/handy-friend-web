...
## ⛔ GOOGLE ADS — АБСОЛЮТНЫЕ ЗАПРЕТЫ (нарушение недопустимо)

**ЗАПРЕЩЕНО любому агенту, в любой сессии, без исключений:**

1. **Performance Max (PMax)** — СОЗДАВАТЬ, ВКЛЮЧАТЬ, РЕДАКТИРОВАТЬ, ВОЗОБНОВЛЯТЬ.
   Причина: Campaign #1 PMax сжёг $280.76 в марте 2026 без единого лида. Владелец не давал разрешения.
   Действие при обнаружении активного PMax: немедленно уведомить владельца, НЕ трогать бюджет.

2. **Broad match keywords** — не добавлять пока нет 50+ конверсий/месяц.

3. **Display Network / Search Partners** — всегда ВЫКЛ на этом аккаунте.

4. **AI Max / Smart campaigns** — не включать без явного письменного разрешения владельца.

5. **tCPA / tROAS / Maximize Conversions** — не переключать пока нет 50+ конверсий/месяц.

6. **Авто-применение рекомендаций Google** — всегда ВЫКЛ (кроме "Удалить дубли ключевых слов").

**Стратегия ставок по умолчанию:** Maximize Clicks — до тех пор пока не будет 50+ конверсий/месяц.
**Аккаунт:** 637-606-8452 | Кампания: LA Search - Core Services (ID 23655774397)
