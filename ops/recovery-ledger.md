...
| 2.4 | Agent B | DONE | `supabase/migrations/20260417120000_038_funnel_events.sql`, `api/funnel-event.js`, `index.html` chat instrumentation | Added funnel table + `v_chat_funnel_7d` view + `/api/funnel-event` endpoint + client events (`page_view`, `widget_seen`, `widget_open`, `chat_first_message`, `phone_captured`, `quote_shown`, `handoff_to_owner`, `abandon`). Pending merge/live validation. | codex/task-2.2-channel-taxonomy | 2026-04-17T07:44 |
